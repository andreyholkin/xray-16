...
#   endif
    ...
    CMD3(CCC_Mask,    "exp_dm_instanced_draw",      &ps_r2_ls_flags_ext, R_FLAGEXT_INSTANCED_DETAILS);
    CMD3(CCC_Mask,    "exp_light_details",          &ps_r2_ls_flags_ext, R_FLAGEXT_LIGHT_DETAILS);
    CMD3(CCC_Mask,    "exp_linear_grass_filter",    &ps_r2_ls_flags_ext, R_FLAGEXT_LINEAR_GRASS_FILTER);
